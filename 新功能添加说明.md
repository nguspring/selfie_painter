...
| 项目 | 原版插件 (v3.3.3) | 修改版插件 (v3.5.0-beta.4) |
|------|-------------------|---------------------|
| 版本号 | 3.3.3 | 3.5.0-beta.4 |
| 文件数量 | 18个文件 | 34个文件 |
| 新增文件 | 0个 | 16个 |
...
### 0.2 🧠 v3.5.0-beta.2 - Smart智能日程模式（重大更新）
...
│   ├── schedule_generator.py        # v3.5.0-beta.2 新增：LLM日程生成器
