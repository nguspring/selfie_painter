...
### _manifest.json
- 版本号更新至 `3.5.2`
- 新增功能列表：定时自拍（多模式）、智能参考搜索、自拍场景配置、内置7个魔搭模型预设、LLM智能场景判断、Times模式自定义场景、日常叙事系统、配文多样化、Hybrid混合模式、Smart智能日程模式
