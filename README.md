...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v3.5.0--beta.9-blue" alt="Version">
...
**v3.5.0-beta.9 新功能**：增强间隔补充日程匹配逻辑，引入"就近条目"策略 + 时间关系感知配文，即使当前时间不在任何日程的精确时间范围内，也会自动使用最接近的日程条目，并智能调整配文风格！
