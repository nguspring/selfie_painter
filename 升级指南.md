...
本指南适用于已安装原版插件的用户，通过替换文件的方式升级到修改版 v3.5.0-beta.4。
...
# v3.5.0-beta.4 角色设定
character_name = "麦麦"  # 角色名称
character_persona = ""  # 角色人设，LLM会根据人设生成符合角色的场景

# v3.5.0-beta.4 Smart模式专用配置
