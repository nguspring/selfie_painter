...
本指南适用于已安装原版插件的用户，通过替换文件的方式升级到修改版 v3.5.2。
...
schedule_mode = "smart"  # smart=智能日程模式（推荐），旧模式(interval/times/hybrid)会自动升级
...
# 以下为旧模式配置（v3.5.2已废弃，仅保留向后兼容）
# schedule_times = ["08:00", "20:00"]
# enable_llm_scene = false
# scene_llm_model = ""
# time_scenes = ["08:00|morning coffee, cafe"]
# ask_model_id = ""
```
